...
/**
 ** \file /home/piter/myCompiler/build/parser.hpp
...
#ifndef YY_YY_HOME_PITER_MYCOMPILER_BUILD_PARSER_HPP_INCLUDED
# define YY_YY_HOME_PITER_MYCOMPILER_BUILD_PARSER_HPP_INCLUDED
// "%code requires" blocks.
#line 19 "src/main/parser.ypp"
...
#line 110 "/home/piter/myCompiler/build/parser.hpp"
...
namespace yy {
#line 250 "/home/piter/myCompiler/build/parser.hpp"
...
# if 201103L <= YY_CPLUSPLUS
  ...
  private:
    ...
    union union_type
    {
      ...
      // proc_call
      char dummy6[sizeof (std::shared_ptr<ProcCall>)];

      // proc_head
      char dummy7[sizeof (std::shared_ptr<ProcHead>)];
      ...
      // args_decl
      char dummy11[sizeof (std::vector<std::shared_ptr<ArgDeclaration>>)];

      // args
      char dummy12[sizeof (std::vector<std::shared_ptr<Args>>)];
        ...
        switch (this->kind ())
    {
      ...
      case symbol_kind::S_args_decl: // args_decl
        value.move< std::vector<std::shared_ptr<ArgDeclaration>> > (std::move (that.value));
        break;
...
#if 201103L <= YY_CPLUSPLUS
      basic_symbol (typename Base::kind_type t, std::vector<std::shared_ptr<ArgDeclaration>>&& v, location_type&& l)
        : Base (t)
        , value (std::move (v))
        , location (std::move (l))
      {}
#else
      basic_symbol (typename Base::kind_type t, const std::vector<std::shared_ptr<ArgDeclaration>>& v, const location_type& l)
        : Base (t)
        , value (v)
        , location (l)
      {}
...
switch (yykind)
    {
      ...
      case symbol_kind::S_args_decl: // args_decl
        value.template destroy< std::vector<std::shared_ptr<ArgDeclaration>> > ();
        break;
    ...
    , location (that.location)
  {
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_args_decl: // args_decl
        value.copy< std::vector<std::shared_ptr<ArgDeclaration>> > (YY_MOVE (that.value));
        break;
  ...
  Parser::basic_symbol<Base>::move (basic_symbol& s)
  {
    ...
    switch (this->kind ())
    {
      ...
      case symbol_kind::S_args_decl: // args_decl
        value.move< std::vector<std::shared_ptr<ArgDeclaration>> > (YY_MOVE (s.value));
        break;
...
#line 2591 "/home/piter/myCompiler/build/parser.hpp"




#endif // !YY_YY_HOME_PITER_MYCOMPILER_BUILD_PARSER_HPP_INCLUDED
