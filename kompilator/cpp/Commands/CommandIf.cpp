...
std::vector<std::string> executeIfCommand(SymbolTable& symbolTable, const CommandIf& commandIf, std::vector<std::shared_ptr<Procedure>>& procedures)
{
    ...
    auto tempVec2 = commandIf.makeAsmValue2(symbolTable);
    auto tempVec1 = commandIf.makeAsmValue1(symbolTable);
