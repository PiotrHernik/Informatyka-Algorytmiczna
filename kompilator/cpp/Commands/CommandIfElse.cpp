...
std::vector<std::string> executeIfElseCommand(SymbolTable& symbolTable, const CommandIfElse& commandIfElse, std::vector<std::shared_ptr<Procedure>>& procedures)
{
    ...
    auto tempVec2 = commandIfElse.makeAsmValue2(symbolTable);
    auto tempVec1 = commandIfElse.makeAsmValue1(symbolTable);
