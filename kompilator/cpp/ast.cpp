...
std::vector<std::string> CommandCondition::makeAsmValue1(SymbolTable& symbolTable)
{
    std::vector<std::string> asmCommands;
...
std::vector<std::string> CommandCondition::makeAsmValue2(SymbolTable& symbolTable)
{
    std::vector<std::string> asmCommands;
